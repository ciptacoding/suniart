...
<li class="breadcrumb-item active" aria-current="page">Edit Sejarah Tari</li>
@endsection
{{-- Breadcrumb --}}
...
<div class="card card-default">
   ...
   <!-- /.card-header -->
   <form action="{{ route('admin.update.sejarah', $sejarahTari->id) }}" method="POST" enctype="multipart/form-data">
      @method('PUT')
      @csrf
      <div class="card-body">
         <div class="row">
            <div class="col-12">
               <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama"
                     placeholder="Masukkan nama tari" value="{{ old('nama', $sejarahTari->nama) }}">
                  @error('nama')
